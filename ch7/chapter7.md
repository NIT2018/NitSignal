...
### §7.7.2 本章目标	2
### §7.8 拉普拉斯变换	2
### §7.9 拉普拉斯变换的收敛域(ROC: Region of Convergence)	4
### §7.10 收敛域的相关性质	4
### §7.11 拉普拉斯反变换	8
### §7.11.1 拉普拉斯反变换公式	8
### §7.11.2 常用变换对	8
...
### §7.12.8 时域积分	11
### §7.12.9 初值与终值定理	11
### §7.13 利用拉氏变换分析和表征LTI系统	11
### §7.13.1 系统函数	11
### §7.13.2 由线性常系数微分方程表征的系统	12
### §7.13.3 LTI系统互联后的系统函数	12
### §7.13.4 用拉氏变换进行系统分析	13
### §7.14 单边拉氏变换	13
...
B_1=-5\\
B_2=4\\
\end{cases}$，即$-1+\frac{6}{1-z^{-1}}+\frac{-5}0{1-2z^{-1}}+\frac{4z^{-1}}{(1-2z^{-1})^2}$ 
...
i)$\begin{cases}
y_{zs}[n]=(-\frac{2}{5}2^n+\frac{9}{35}(-3)^n+\frac{8}{7}4^n)u[n]\\
y_{zi}[n]=(\frac{4}{5}2^n-\frac{9}{5}(-3)^n)u[n]\\
\end{cases}$
