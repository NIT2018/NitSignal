...
c)	$a_k=\frac{2\sin(k\omega_0T_1)}{k\pi}=\frac{\omega_0T_1}{\pi}Sa(k\omega_0T_1)=\frac{\omega_0T_1}{\pi}Sa(kT_1)$ ，此处注意两点：$a_0$也可以包含在内；ak就是Sa在几个离散点的取值，具体密度由w0决定。
...
4)	因为在$-T_0$/2到$T_0$/2区间内，有 代入上式，即有
