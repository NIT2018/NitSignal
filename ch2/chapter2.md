...
- i.	解：首先可以列出回路方程； f(n)= \begin{cases} Ri(t)+v_c(t)=e(t)\Lambda \Lambda(1), \\ v_c(t)=L$ \frac{{\rm d}i_L(t)}{{\rm d}t}\Lambda \Lambda(2)  , \\i(t)=c$ \left. \frac{{\rm d}v_c(t)}{{\rm d}t}   +i_L(t)\Lambda \Lambda(3) \end{cases}  ，目标是得到i(t)和e(t)的表达式。(3)式两边对t求导，得$  \frac{{\rm d}i(t)}{{\rm d}t} $=c$ \frac{{\rm d^2}v_c(t)}{{\rm d}t^2} $+L$ \frac{{\rm d}i_L(t)}{{\rm d}t}  \lambda (4) $，将（2）式代入（4）式，有$ \frac{{\rm d}i(t)}{{\rm d}t} $=c$ \frac{{\rm d^2}v_c(t)}{{\rm d}t^2} $+ $ \frac{{\rm d}i_L(t)}{{\rm d}t} \Lambda $ (5)，再将（1）式带入（5）式，有$ \frac{{\rm d}i(t)}{{\rm d}t}$=c$ \frac{{\rm d^2}e(t)-R_i(t)}{{\rm d}t^2} $+$ \frac{e(t)-R_i(t)}{L}\Lambda $ (6) ，最后整理得$ \frac{{\rm d^2}i(t)}{{\rm d}t^2}  $ +1/RC$ \frac{\rm d}i(t)}{{\rm d}t} $+1/LCi(t)=1/R$ \frac{{\rm d^2}e(t)}{{\rm d}t^2}  $+$ 1/RLCe(t)\Lambda \Lambda $(7)带入参数值后得 $ \frac{{\rm d^2}i(t)}{{\rm d}t^2}+4$ \frac{{\rm d}i(t)}{{\rm d}t} $+3i(t)=$ \frac{{\rm d^2}e(t)}{{\rm d}t^2} $+$ 3e(t)\Lambda \Lambda $(8)
