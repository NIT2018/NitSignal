...
3)	例3：求周期函数x[n]傅立叶级数的系数。$$x[n]=x[n+N].x[n]=\begin{cases} 1, & \text{-$N_1$ $\leq$ n $\leq$ $N_1$} \\ 0, & \text{$N_1$<|n|<N}\end{cases}$$
    ...
    c)	做变量替换，$m=n+N_1$，有$$a_k=\frac{1}{N}\sum_{m=0}^{2N_1} {\it e}^{-jk(2\pi/N)(m-N_1)}=\frac{1}{N}{\it e}^{jk2\pi N_1/N}\sum_{m=0_1}^{2N_1} {\it e}^{-jk(2\pi/N)m}=\frac{1}{N}{\it e}^{jk2\pi N_1/N}\frac{1-{\it e}^{-jk(2\pi/N)(2N_1+1)}}{1-{\it e}^{-jk2\pi /N}}=\frac{1}{N} \frac{{\it e}^{-jk\frac{2\pi}{2N}}({\it e}^{jk\frac{2\pi}{2N}(2N_1+1)}-{\it e}^{-jk\frac{2\pi}{2N}(2N_1+1)})}{{\it e}^{-jk\frac{2\pi}{2N}}({\it e}^{jk\frac{2\pi}{2N}}-{\it e}^{-jk\frac{2\pi}{2N}})}$$
