...
### 4.5.2 线性性质 
1)	若 $$x_1[n] \underleftrightarrow{F} X_1({\it e}^{j\omega})$$,$$x_2[n] \leftrightarrow X_2({\it e}^{j\omega})$$，则 $$ax_1[n]+bx_2[n] \leftrightarrow aX_1({\it e}^{j\omega})+bX_2({\it e}^{j\omega})$$
### 4.5.3 对称性 
