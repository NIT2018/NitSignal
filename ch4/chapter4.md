...
a)	解：$$X({\it e}^{j\omega})=\sum_{n=-\infty}^{+\infty} x[n]{\it e}^{-j\omega n}=\sum_{n=0}^{=\infty} a^n{\it e}^{-j\omega n}=\sum_{n=0}^{+\infty} (a{\it e}^{-j\omega})^n=\frac{1-(a{\it e}^{-j\omega})^\infty}{1-a{\it e}^{-j\omega}}$$
